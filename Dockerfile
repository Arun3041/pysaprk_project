...
RUN aws configure set aws_access_key_id AKIA2GXT73H7NWVZGZAN
RUN aws configure set aws_secret_access_key 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
...
CMD ["spark-submit","--jars", "/opt/spark/jars/postgresql-connector.jar","--packages","com.amazonaws:aws-java-sdk-s3:1.12.196,org.apache.hadoop:hadoop-aws:3.3.1","/app/script.py","--table","s3_to_pg"]